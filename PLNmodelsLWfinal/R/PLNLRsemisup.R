...
#'
#' @return an R6 object with class [PLNLRsemisupfit()]
#'
...
#' @seealso The class [`PLNLRsemisupfit`]
#' @importFrom stats model.frame model.matrix model.response model.offset
#' @export
PLNLRsemisup <- function(formula, data, subset, weights, grouping, control = PLN_param()) {
  ...
  # Initialize model
  myPLNLRsemisup <- PLNLRsemisupfit$new(grouping, args$Y, args$X, args$O, args$w, args$formula, control)
  
  ## Compute the group means
  if (control$trace > 0) cat("\n Fitting model...")
  myPLNLRsemisup$optimize(args$Y, args$X, args$O, args$w, control$config_optim)

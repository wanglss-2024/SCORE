...
#'
#' @description The function \code{\link{PLNLRunsup}} produces a collection of models which are instances of object with class \code{PLNmixturefit}.
#'
...
#' @seealso The function \code{\link{PLNLRunsup}}
PLNLRunsupfit <-
  R6Class(classname = "PLNLRunsupfit",
          ...
          public  = list(
            ...
            #' @description Optimize a [`PLNLRunsupfit`] model
            ...
            predict = function(newdata,
              ...
              args <- extract_model(call("PLNLRunsup", formula = private$formula, data = newdata), envir)

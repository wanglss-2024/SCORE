...
#' Mixture visualization of a [`PLNfixedVsemisupfit`] object
#'
...
#'
#' @name plot.PLNfixedVsemisupfit
#'
#' @param x an R6 object with class [`PLNfixedVsemisupfit`]
...
#'
#' @seealso [sigma.PLNfixedVsemisupfit()]
#'
#' @export
#' @examples
#' data(trichoptera)

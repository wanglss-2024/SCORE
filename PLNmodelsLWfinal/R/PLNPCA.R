...
#' @export
PLNPCA <- function(formula, data, subset, weights, grouping, ranks = 1:5, control = PLNPCA_param()) {
  ...
  myPCA <- PLNPCAfamily$new(ranks, grouping, args$Y, args$X, args$O, args$w, args$formula, control)

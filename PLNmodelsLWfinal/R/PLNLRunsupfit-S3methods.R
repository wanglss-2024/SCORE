## =========================================================================================
##
## PUBLIC S3 METHODS FOR PLNLRunsupfit
##
## =========================================================================================

## Auxiliary functions to check the given class of an objet
isPLNLRunsupfit <- function(Robject) {inherits(Robject, "PLNLRunsupfit"       )}

#' Mixture visualization of a [`PLNLRunsupfit`] object
#'
...
#'
#' @name plot.PLNLRunsupfit
#'
#' @param x an R6 object with class [`PLNLRunsupfit`]
...
coef.PLNLRunsupfit <- function(object, type = c("main", "means", "covariance", "mixture"), ...) {
  stopifnot(isPLNLRunsupfit(object))

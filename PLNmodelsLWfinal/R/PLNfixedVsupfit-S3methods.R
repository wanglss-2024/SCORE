...
#' LDA visualization (individual and/or variable factor map(s)) for a [`PLNfixedVsupfit`] object
#'
#' @name plot.PLNLDAfit
#'
#' @param x an R6 object with class PLNfixedVsupfit

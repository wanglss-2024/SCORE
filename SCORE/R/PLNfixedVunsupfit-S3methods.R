## =========================================================================================
##
## PUBLIC S3 METHODS FOR PLNfixedVunsupfit
##
## =========================================================================================

## Auxiliary functions to check the given class of an objet
isPLNfixedVunsupfit <- function(Robject) {inherits(Robject, "PLNfixedVunsupfit"       )}

#' Mixture visualization of a [`PLNfixedVunsupfit`] object
#'
...
#'
#' @name plot.PLNfixedVunsupfit
#'
#' @param x an R6 object with class [`PLNfixedVunsupfit`]
...
#' Prediction for a [`PLNfixedVunsupfit`] object
#'
#' Predict either posterior probabilities for each group or latent positions based on new samples
#'
#' @param object an R6 object with class [`PLNfixedVunsupfit`]
...
#'
#' @seealso [sigma.PLNfixedVunsupfit()]
#'
#' @export
#' @examples
#' data(trichoptera)
...
coef.PLNfixedVunsupfit <- function(object, type = c("main", "means", "covariance", "mixture"), ...) {
  stopifnot(isPLNfixedVunsupfit(object))

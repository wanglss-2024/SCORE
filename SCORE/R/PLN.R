...
PLN <- function(formula, data, subset, weights, control = PLN_param()) {
  ...
  myPLN <- switch(control$covariance,
      ...
      "fixedV"   = PLNfit_fixedv$new(args$Y, args$X, args$O, args$w, args$formula, control),
      "lowrank"  = PLNfit_lowrank$new(args$Y, args$X, args$O, args$w, args$formula, control),
      "fixedc"   = PLNfit_fixedc$new(args$Y, args$X, args$O, args$w, args$formula, control),
  ...
  ## Added: smooth M and S over Y, then additional M step
  if (control$covariance == "fixedV") {
    cat("\n  Starting M step...")
    myPLN$optimize_mstep(args$Y, args$X, args$O, args$w, control$config_optim)
  }
...
PLN_param <- function(
    ...
    trace         = 1,
    covariance    = c("full", "diagonal", "spherical", "fixed", "fixedV", "lowrank", "fixedc"),
    Omega         = NULL,
    V             = NULL,
    C             = NULL,
    rank          = NULL,
  ...
  if (covariance == "fixedV") stopifnot(inherits(V, "matrix") | inherits(V, "Matrix"))
